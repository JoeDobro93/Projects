...
/**
 * Interface for AnimationBuilder.  There was no javadoc here so I am putting it in to appease the
 * Java Style gods.
 *
 * @param <Doc> Generic type which we will "replace" with our modelimpl.
 */
