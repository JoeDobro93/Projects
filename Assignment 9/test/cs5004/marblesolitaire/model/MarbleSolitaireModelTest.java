...
/**
 * Test suite for all methods in MarbleSolitaireModel, including a setup that sets up every type of
 * constructor to prove that no exceptions are thrown.  Also includes some private helper functions
 * to play through a winning game and a losing game..
 */
public class MarbleSolitaireModelTest {
  ...
  @Before
  public void setUp() {
    size3board = new MarbleSolitaireModelImpl();
    size3board2 = new MarbleSolitaireModelImpl(5, 4);
    size5board = new MarbleSolitaireModelImpl(5);
    size7board = new MarbleSolitaireModelImpl(7, 3, 9);

    winningGame = new MarbleSolitaireModelImpl();
    dudGame = new MarbleSolitaireModelImpl();
    setUpWinningGame();
    setUpDudGame();
  }
  ...
  private void setUpWinningGame() {
    ...
    winningGame.move(3, 4, 5, 4);
    winningGame.move(5, 4, 5, 2);
    winningGame.move(5, 2, 3, 2);
    winningGame.move(3, 2, 1, 2);
    winningGame.move(2, 0, 4, 0);
    winningGame.move(4, 0, 4, 2);
    winningGame.move(4, 2, 4, 4);
    ...
    winningGame.move(2, 3, 2, 5);
    winningGame.move(2, 5, 4, 5);
    winningGame.move(4, 5, 4, 3);
    winningGame.move(4, 3, 2, 3);
    winningGame.move(1, 3, 3, 3);
  }
  ...
  public void badConstructorTest() {
    ...
    try {
      failMe = new MarbleSolitaireModelImpl(7, 3);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
      assertEquals("INVALID COORDINATE", e.getMessage());
    }

    try {
      failMe = new MarbleSolitaireModelImpl(-5, 3);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
      assertEquals("INVALID COORDINATE", e.getMessage());
    ...
    try {
      failMe = new MarbleSolitaireModelImpl(3, 9);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
      assertEquals("INVALID COORDINATE", e.getMessage());
    ...
    try {
      failMe = new MarbleSolitaireModelImpl(5, -1);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
      assertEquals("INVALID COORDINATE", e.getMessage());
    ...
    try {
      failMe = new MarbleSolitaireModelImpl(3, 0, 0);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
      assertEquals("SPACE NOT IN PLAYING AREA", e.getMessage());
    }

    try {
      failMe = new MarbleSolitaireModelImpl(3, 1, 0);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
      assertEquals("SPACE NOT IN PLAYING AREA", e.getMessage());
    ...
    try {
      failMe = new MarbleSolitaireModelImpl(-5);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
    ...
    try {
      failMe = new MarbleSolitaireModelImpl(-2);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
      assertEquals("ARM THICKNESS MUST BE AT LEAST 3", e.getMessage());
    ...
    try {
      failMe = new MarbleSolitaireModelImpl(6);
      fail();
    } catch (Exception e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
  ...
  public void getGameState() {
    assertEquals("    _ _ _\n" +
            ...
            "_ _ _ _ _ _ _\n" +
            "    _ _ _\n" +
            "    _ _ _", winningGame.getGameState());
  ...
  public void getScore() {
    assertEquals(32, size3board.getScore());
    assertEquals(size3board.getScore(), size3board2.getScore());
    assertEquals(104, size5board.getScore());
    assertEquals(216, size7board.getScore());
    assertEquals(1, winningGame.getScore());
    assertEquals(5, dudGame.getScore());
  }
}