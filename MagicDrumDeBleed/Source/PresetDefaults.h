...
static constexpr FactoryPreset kKick    { "Kick",     70.0f, 1.9f,   5, 50.0f, 60.0f, true,   70.0f,  2.5f, 12.0f, 180.0f,  250.0f };   // 0.75 oct focus
static constexpr FactoryPreset kSnare   { "Snare",   220.0f, 3.5f,   5, 10.0f, 20.0f, true,  220.0f,  8.0f, 16.0f, 200.0f,  600.0f };   // 0.41 oct focus
static constexpr FactoryPreset kToms    { "Toms",    150.0f, 2.4f,   5, 25.0f, 50.0f, true,  150.0f,  2.0f, 14.0f, 400.0f, 1000.0f };   // 0.60 oct focus
