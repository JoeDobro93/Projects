...
inline const Palette& light()
{
    static const Palette p = []{
        ...
        l.panel2  = juce::Colour (0xffeaeef3);
        l.line    = juce::Colour (0xffd0d7e0);
        l.txt     = juce::Colour (0xff1c2531);
        l.dim     = juce::Colour (0xff5d6a7a);
        l.faint   = juce::Colour (0xff8894a4);
        l.knob    = juce::Colour (0xffdde3ea);
        l.knobEdge= juce::Colour (0xffc2ccd8);
        l.btn     = juce::Colour (0xffdfe5ec);
